...
var getUniqueErrorMessage = function (err) {
  ...
  try {
    ...
    output = fieldName.charAt(0).toUpperCase() + fieldName.slice(1) + ' đã tồn tại trong hệ thống';

  } catch (ex) {
    output = 'Thông tin này đã tồn tại trong hệ thống';
  }
